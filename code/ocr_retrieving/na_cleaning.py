...
df_1988 = pd.read_csv('data/final/final_clean/archelect_1988_clean.csv')
df_1993 = pd.read_csv('data/final/final_clean/archelect_1993_clean.csv')
...
df_1988.to_csv('data/final/final_clean/archelect_1988_clean.csv', index=False, encoding='utf-8')
df_1993.to_csv('data/final/final_clean/archelect_1993_clean.csv', index=False, encoding='utf-8')
df_full.to_csv('data/final/final_clean/archelect_full_clean.csv', index=False, encoding='utf-8')